...
//         if(str[i] === 'c') {
//             if(/(co([a-z])e)/g.test(str.slice(i, i + 4))) {
//                 count++;
//                 i += 3;
//             }
//         }
...
// console.log(countCode("aaacodecodecowecobebbcoreb"));
...
console.log(countCode("codedkajd;fkjaijcozedjfaijfjcomeajfaifjconeco8e"));